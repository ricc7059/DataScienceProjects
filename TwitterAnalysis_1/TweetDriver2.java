...
public class TweetDriver2 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (args.length != 2) {
      System.out.printf(
          "Usage: TweetWordCount2 <input dir> <output dir>\n");
      System.exit(-1);
    }
     ...
     */
    job.setJobName("Tweet Word Count 2");
    ...
    job.setReducerClass(TweetReducer2.class);
    ...
    //set number of reducers to one to get all output into one file
